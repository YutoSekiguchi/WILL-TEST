...
import InkStorage from "../scripts/InkStorage";
      ...
      <div className="app">
		<nav>
			<div>
				...
				{/* <input id="load_file" type="file" className="Button" onChange={app.inkStorage.import(this, 'uim')} /> */}

				<img src="/images/btn_save.png" title="Save" onClick={() => InkStorage.save()} alt="" />

				<span className="ColorBox Delimiter">
					<a href="" title="Color" className="Item Color" style={{backgroundColor: "#000000"}}>
						<input type="color" defaultValue="#000000" />
					</a>
				</span>

				<span className="TextBox Delimiter">
					<a href="" title="Color" className="Item Text">
				...
				<div className="BackToMenu">
					<a href="" title="Toggle Pointer prediction" className="Button pointerPrediction" onClick={() => layout.toggleParam('pointerPrediction')}>PP</a>
					<a href="" title="Toggle downsampling" className="Button downsampling" onClick={() => layout.toggleParam('downsampling')}>DS</a>
		...
		<div className="Wrapper">
			<div className="pressure-progress-wrapper">
				<div className="pressure-progress"></div>
			</div>
